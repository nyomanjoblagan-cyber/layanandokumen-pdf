...
const TOOLS = [
  ...
  { id: 'merge-pdf', title: { id: 'Gabung PDF', en: 'Merge PDF' }, desc: { id: 'Satukan banyak file PDF menjadi satu.', en: 'Combine multiple PDFs into one file.' }, icon: Combine, category: 'Populer', color: 'text-purple-600', bg: 'bg-purple-50', border_hover: 'hover:border-purple-300' },
  { id: 'compress-pdf', title: { id: 'Kompres PDF', en: 'Compress PDF' }, desc: { id: 'Kecilkan ukuran file agar mudah dikirim.', en: 'Reduce file size for easy sharing.' }, icon: Minimize, category: 'Populer', color: 'text-green-600', bg: 'bg-green-50', border_hover: 'hover:border-green-300' },
  { id: 'split-pdf', title: { id: 'Pisah PDF', en: 'Split PDF' }, desc: { id: 'Ambil halaman tertentu atau pecah file.', en: 'Extract pages or split documents.' }, icon: Scissors, category: 'Populer', color: 'text-red-600', bg: 'bg-red-50', border_hover: 'hover:border-red-300' },
  { id: 'edit-pdf', title: { id: 'Edit PDF', en: 'Edit PDF' }, desc: { id: 'Tambahkan teks, tanda, dan coretan.', en: 'Add text, shapes, and annotations.' }, icon: FilePenLine, category: 'Populer', color: 'text-indigo-600', bg: 'bg-indigo-50', border_hover: 'hover:border-indigo-300' },
  { id: 'scan-pdf', title: { id: 'Scan PDF', en: 'Scan PDF' }, desc: { id: 'Scan dokumen fisik menggunakan kamera.', en: 'Scan physical docs using camera.' }, icon: Camera, category: 'Populer', color: 'text-blue-600', bg: 'bg-blue-50', border_hover: 'hover:border-blue-300' },

  // 2. KONVERSI
  { id: 'pdf-to-jpg', title: { id: 'PDF ke JPG', en: 'PDF to JPG' }, desc: { id: 'Simpan halaman PDF jadi gambar JPG.', en: 'Save PDF pages as JPG images.' }, icon: Image, category: 'Konversi', color: 'text-yellow-600', bg: 'bg-yellow-50', border_hover: 'hover:border-yellow-300' },
  { id: 'pdf-to-png', title: { id: 'PDF ke PNG', en: 'PDF to PNG' }, desc: { id: 'Simpan halaman PDF jadi gambar PNG.', en: 'Convert PDF pages to PNG images.' }, icon: FileImage, category: 'Konversi', color: 'text-teal-600', bg: 'bg-teal-50', border_hover: 'hover:border-teal-300' },
  { id: 'pdf-to-text', title: { id: 'PDF ke Text', en: 'PDF to Text' }, desc: { id: 'Ekstrak tulisan dari PDF ke Notepad.', en: 'Extract text content to Notepad.' }, icon: FileText, category: 'Konversi', color: 'text-slate-600', bg: 'bg-slate-50', border_hover: 'hover:border-slate-300' },
  { id: 'png-to-pdf', title: { id: 'PNG ke PDF', en: 'PNG to PDF' }, desc: { id: 'Gabungkan gambar PNG jadi PDF.', en: 'Merge PNG images into PDF.' }, icon: FileImage, category: 'Konversi', color: 'text-cyan-600', bg: 'bg-cyan-50', border_hover: 'hover:border-cyan-300' },
  { id: 'flatten-pdf', title: { id: 'Ratakan PDF', en: 'Flatten PDF' }, desc: { id: 'Kunci form & elemen interaktif.', en: 'Lock forms & interactive elements.' }, icon: Layers, category: 'Konversi', color: 'text-gray-700', bg: 'bg-gray-100', border_hover: 'hover:border-gray-300' },
  { id: 'pdf-to-html', title: { id: 'PDF ke HTML', en: 'PDF to HTML' }, desc: { id: 'Konversi PDF jadi halaman web.', en: 'Convert PDF to web page.' }, icon: FileCode, category: 'Konversi', color: 'text-pink-600', bg: 'bg-pink-50', border_hover: 'hover:border-pink-300' },

  // 3. EDIT & ATUR
  { id: 'rotate-pdf', title: { id: 'Putar PDF', en: 'Rotate PDF' }, desc: { id: 'Perbaiki orientasi halaman PDF.', en: 'Fix PDF page orientation.' }, icon: RefreshCcw, category: 'Edit', color: 'text-violet-600', bg: 'bg-violet-50', border_hover: 'hover:border-violet-300' },
  { id: 'delete-pages', title: { id: 'Hapus Halaman', en: 'Delete Pages' }, desc: { id: 'Buang halaman yang tidak diinginkan.', en: 'Remove unwanted pages.' }, icon: Trash2, category: 'Edit', color: 'text-rose-600', bg: 'bg-rose-50', border_hover: 'hover:border-rose-300' },
  { id: 'rearrange-pdf', title: { id: 'Urutkan Halaman', en: 'Rearrange' }, desc: { id: 'Geser posisi urutan halaman.', en: 'Reorder page positions.' }, icon: Layout, category: 'Edit', color: 'text-blue-500', bg: 'bg-blue-50', border_hover: 'hover:border-blue-300' },
  { id: 'extract-pages', title: { id: 'Ambil Halaman', en: 'Extract Pages' }, desc: { id: 'Simpan halaman pilihan saja.', en: 'Save only selected pages.' }, icon: FileUp, category: 'Edit', color: 'text-emerald-600', bg: 'bg-emerald-50', border_hover: 'hover:border-emerald-300' },
  { id: 'add-page-numbers', title: { id: 'Nomor Halaman', en: 'Page Numbers' }, desc: { id: 'Sisipkan nomor halaman otomatis.', en: 'Insert automatic page numbers.' }, icon: BookOpen, category: 'Edit', color: 'text-slate-600', bg: 'bg-slate-50', border_hover: 'hover:border-slate-300' },
  { id: 'resize-pdf', title: { id: 'Ubah Ukuran', en: 'Resize PDF' }, desc: { id: 'Ganti ukuran kertas (A4/Letter).', en: 'Change paper size (A4/Letter).' }, icon: Maximize, category: 'Edit', color: 'text-fuchsia-600', bg: 'bg-fuchsia-50', border_hover: 'hover:border-fuchsia-300' },
  { id: 'add-image-pdf', title: { id: 'Tambah Gambar', en: 'Add Image' }, desc: { id: 'Sisipkan logo atau foto ke PDF.', en: 'Insert logo or photo into PDF.' }, icon: FileImage, category: 'Edit', color: 'text-lime-600', bg: 'bg-lime-50', border_hover: 'hover:border-lime-300' },
  { id: 'fill-form', title: { id: 'Isi Formulir', en: 'Fill Forms' }, desc: { id: 'Isi kolom formulir digital.', en: 'Fill digital form fields.' }, icon: PenTool, category: 'Edit', color: 'text-indigo-600', bg: 'bg-indigo-50', border_hover: 'hover:border-indigo-300' },

  // 4. KEAMANAN
  { id: 'protect-pdf', title: { id: 'Kunci PDF', en: 'Protect PDF' }, desc: { id: 'Enkripsi PDF dengan password.', en: 'Encrypt PDF with password.' }, icon: Lock, category: 'Keamanan', color: 'text-slate-800', bg: 'bg-slate-200', border_hover: 'hover:border-slate-400' },
  { id: 'unlock-pdf', title: { id: 'Buka Password', en: 'Unlock PDF' }, desc: { id: 'Hapus proteksi password PDF.', en: 'Remove PDF password protection.' }, icon: Unlock, category: 'Keamanan', color: 'text-pink-600', bg: 'bg-pink-50', border_hover: 'hover:border-pink-300' },
  { id: 'watermark-pdf', title: { id: 'Watermark', en: 'Watermark' }, desc: { id: 'Tempel cap teks transparan.', en: 'Add transparent text stamp.' }, icon: BadgeCheck, category: 'Keamanan', color: 'text-red-700', bg: 'bg-red-50', border_hover: 'hover:border-red-300' },
  { id: 'esign-pdf', title: { id: 'Tanda Tangan', en: 'eSign PDF' }, desc: { id: 'Buat tanda tangan digital.', en: 'Create digital signature.' }, icon: FileSignature, category: 'Keamanan', color: 'text-blue-800', bg: 'bg-blue-100', border_hover: 'hover:border-blue-300' },
];
