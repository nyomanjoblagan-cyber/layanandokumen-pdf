...
import { 
  Image as ImageIcon, FileText, CheckCircle2, Download, 
  ArrowLeft, Loader2, Settings2, Plus, Trash2, ImagePlus, 
...
export default function JpgToPdfPage() {
  ...
  // Memori Leak Prevention: Hapus blob URL jika file dihapus/reset
  useEffect(() => {
    return () => {
  ...
  return (
    <ToolLayout
      ...
      titleDesktop={<>JPG<span className="text-orange-600">2PDF</span></>}
      titleMobile={<>JPG to <span className="text-orange-600">PDF</span></>}
      icon={<ImageIcon size={18} />}
      iconBgColor="bg-orange-600"
      selectionClass="selection:bg-orange-100 selection:text-orange-700"
    >
        {/* VIEW 1: UPLOAD */}
        {files.length === 0 ? (
          <div 
